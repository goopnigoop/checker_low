...
class FibonacciRecursionSupplierImplTest {

    FibonacciRecursionSupplierImpl fibonacciRecursionSupplier = new FibonacciRecursionSupplierImpl();



    @Test
    void shouldReturnTenProperFibonacciNumbers() {
        final Stream<Integer> nFibonacciNumbers = fibonacciRecursionSupplier.getNFibonacciNumber(10);
